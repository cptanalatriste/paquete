# `paquete` developer documentation
...
# install paquete as an editable package
...
The second is to use `tox`, which can be installed separately (e.g. with `pip install tox`), i.e. not necessarily inside the virtual environment you use for installing `paquete`, but then builds the necessary virtual environments itself by simply running:
...
cd $(mktemp -d paquete.XXXXXX)
git clone git@github.com:cptanalatriste/paquete .
...
Visit
[https://test.pypi.org/project/paquete](https://test.pypi.org/project/paquete)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d paquete-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple paquete
```
...
Don't forget to also make a [release on GitHub](https://github.com/cptanalatriste/paquete/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.