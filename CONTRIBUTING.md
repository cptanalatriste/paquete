...
1. use the search functionality [here](https://github.com/cptanalatriste/paquete/issues) to see if someone already filed the same issue;
...
1. [push](http://rogerdudler.github.io/git-guide/) your feature branch to (your fork of) the paquete repository on GitHub;
...
1. Wait until [PyPi publish workflow](https://github.com/cptanalatriste/paquete/actions/workflows/publish.yml) has completed
...
1. Wait until new release is also on Bioconda (https://anaconda.org/bioconda/paquete) via a automaticly created PR on [bioconda recipes repo](https://github.com/bioconda/bioconda-recipes/pulls?q=is%3Apr+is%3Aopen+paquete)
1. Test paquete from bioconda by manually running [Conda verify](https://github.com/cptanalatriste/paquete/actions/workflows/conda_verify.yml) workflow
-->
